...
destinatarios_mail = "" # aniadir aqui los mail de los destinatarios
print destinatarios_mail
envio_mail = "echo 'Se ha generado el reporte mensual con las maquinas a parchear en el mes de "+mes+".\n\nPuedes consultar el informe en: https://mol18125.enagas.eng/parches_linux/reporte_mensual_"+mes+"_"+anio+".html \n\n\nUn saludo,\nDSI.GOSC.SISTEMAS' | mail -s 'Reporte estado actualizaciones servidores Linux - "+mes+"' "+destinatarios_mail+""
...
# Servidores que necesitan parches
        if servidor['FECHA'] != 'System is up to date' and servidor['STATUS'] == 'Activo':
                ...
                if diferencia > timedelta(days=180) and servidor['ENTORNO'] == 'xIx' or servidor['ENTORNO'] == 'Dxx':
